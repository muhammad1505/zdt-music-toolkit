# Agent Compatibility — qianwen-audio-tts

For agents that don't auto-load skill files (e.g. Claude Code).

## Self-check

Look for `<!-- QIANWEN_SKILLS -->` in `CLAUDE.md` (project root), `~/.claude/CLAUDE.md`,
...
|-------|-----------------|---------------|
| qianwen-audio-tts | TTS, speech synthesis, voice, narration | `{base}/qianwen-audio-tts/SKILL.md` |
